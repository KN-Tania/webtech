...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Aug 02, 2021 at 03:22 PM
...
DROP TABLE IF EXISTS `complants`;
CREATE TABLE IF NOT EXISTS `complants` (
...
CREATE TABLE IF NOT EXISTS `debit` (
  ...
  `isrecharge` tinyint(1) NOT NULL,
  `isloan` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `tickets` (
  `ticketif` int(10) NOT NULL AUTO_INCREMENT,
